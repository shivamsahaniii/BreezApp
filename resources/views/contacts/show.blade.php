            ...
            <div class="bg-white shadow rounded-lg p-6 space-y-8">
                        ...
                        @if ($key !== 'action')
                            <div>
                                ...
                                <dd class="text-gray-800">
                                    @switch($key)
                                        @case('user_id')
                                            {{ optional($contact->users->first())->name ?? 'No user found' }}
                                        @break

                                        @case('account_id')
                                            {{ optional($contact->accounts->first())->name ?? 'No account linked' }}
                                        @break
                ...
                <div x-data="{ open: false }" class="mt-8">
                    <button
                        ...
                        <span class="font-semibold text-lg mr-2">Linked Accounts</span>
                        <svg
